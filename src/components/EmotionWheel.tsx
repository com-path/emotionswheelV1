              ...
              >
                <defs>
                  {emotions.map((emotion) => (
                    <linearGradient key={emotion.name} id={`gradient-${emotion.name}`} x1="0%" y1="0%" x2="100%" y2="100%">
              ...
              {selectedEmotions.length === 0 ? (
                ...
                <div className="space-y-3 mb-6">
                  {selectedEmotions.map((selected) => (
                    <div
                      key={`${selected.emotion.name}-${selected.intensity.level}`}
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        />
                        <span className="font-medium text-gray-900">{selected.emotion.name} - {selected.intensity.level}</span>
                      </div>
                      <button
